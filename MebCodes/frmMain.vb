Public Class frmMain
    Dim il As Integer = 1, ilce As Integer = 1, sayfa As Integer = 1, ad As String
    ...
    Private Sub WebBrowser1_DocumentCompleted(sender As Object, e As WebBrowserDocumentCompletedEventArgs) Handles WebBrowser1.DocumentCompleted
        ...
        'sayfa kontrol
        If txtLists.Text = "" Then sayfa = 0 : btnNext_Click("ilce", e)
        'kaydet ve geç
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        For Each line In txtLists.Text.Split(vbCrLf)
            ...
            If items.Count > 1 Then Dim sonuc = db.InsertSchool(il, il, items(1), items(0), items(2))
        Next
